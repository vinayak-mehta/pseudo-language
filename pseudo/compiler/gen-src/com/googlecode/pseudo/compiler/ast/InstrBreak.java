 ...
 */
public class InstrBreak extends Instr {
   private IdToken id_optional;
         private Semis semis;
             public InstrBreak(IdToken id_optional,Semis semis) {
    ...
    public PseudoProductionEnum getKind() {
      return PseudoProductionEnum.instr_break;
    }
  ...
  public <_R,_P,_E extends Exception> _R accept(Visitor<? extends _R, ? super _P, ? extends _E> visitor, _P param) throws _E {
   ...
   public String toString() { 
     return "_break" + " "((id_optional==null)?"":id_optional.toString()) + " "((semis==null)?"":semis.toString());
   }*/
}

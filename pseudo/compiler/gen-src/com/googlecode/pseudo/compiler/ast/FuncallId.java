 ...
 */
public class FuncallId extends Funcall {
   private IdToken id;
         private Arguments arguments;
             public FuncallId(IdToken id,Arguments arguments) {
    ...
    public PseudoProductionEnum getKind() {
      return PseudoProductionEnum.funcall_id;
    }
  ...
  public <_R,_P,_E extends Exception> _R accept(Visitor<? extends _R, ? super _P, ? extends _E> visitor, _P param) throws _E {
   ...
   public String toString() { 
     return ((id==null)?"":id.toString()) + " ""lpar" + " "((arguments==null)?"":arguments.toString()) + " ""rpar";
   }*/
}

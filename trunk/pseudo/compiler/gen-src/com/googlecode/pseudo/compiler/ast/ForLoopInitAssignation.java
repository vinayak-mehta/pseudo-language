 ...
 */
public class ForLoopInitAssignation extends ForLoopInit {
   private Assignation assignation;
             public ForLoopInitAssignation(Assignation assignation) {
    this.assignation=reparent(null,assignation);
              }
    
    @Override
    public PseudoProductionEnum getKind() {
      return PseudoProductionEnum.for_loop_init_assignation;
    }
